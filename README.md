...
Smart Contract & CEX/DEX Engineer. 15+ years in software, 6 in Web3.

I build the systems that price, match, and settle trades on-chain: AMM/DEX mechanics,
CLOB matching engines, Solidity contracts, and the indexers and signing services that
...
**Stack:** Solidity · Go · TypeScript · Rust · Node.js · React · Hardhat · OpenZeppelin · PostgreSQL

**Open to:** Senior smart contract / protocol / backend Web3 roles. Remote or Dubai.
Contact: scub111b@gmail.com · LinkedIn: https://www.linkedin.com/in/konstantin-biskub
